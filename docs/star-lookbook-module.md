...
6. ~~한국형 배경 프리셋~~ ✅ 완료 — sceneBrief 빠른선택 칩 6종(성수동 카페/한남동 거리/미니멀 스튜디오/한강 공원/도심 야경/화이트 홈), 칩 라벨 ko/en·프롬프트 텍스트는 영문. `SCENE_PRESETS` in `fanletter-lookbook-studio-page.tsx`. 직접 입력도 유지.
