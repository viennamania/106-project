...
function getFounderUniverseInvestorMeta(locale: Locale) {
  if (locale === "ko") {
    return {
      description:
        "AIAVpark 크리에이터 네트워크 기반 AI 스타 인큐베이터 모델을 라이브 데이터로 보여주는 투자자용 인포그래픽입니다.",
      title: "크리에이터 네트워크 인포그래픽 | AIAVpark",
    };
  }

  return {
    description:
      "An investor-facing live-data infographic for the AIAVpark Creator Network AI Star incubation model.",
    title: "Creator Network Infographic | AIAVpark",
  };
}
