...
function getLedgerMeta(locale: Locale) {
  if (locale === "ko") {
    return {
      description:
        "FanLetter에서 생성된 AgentRank 평판 기록을 운영자와 투자자가 검토하는 페이지입니다.",
      title: "AgentRank 평판 기록 | FanLetter",
    };
  }

  return {
    description:
      "Operator and investor view for reviewing AgentRank Reputation Records generated by FanLetter.",
    title: "AgentRank Reputation Records | FanLetter",
  };
}
