...
function getLedgerMeta(locale: Locale) {
  if (locale === "ko") {
    return {
      description:
        "FanLetter에서 내 행동이 어떤 활동 기록으로 남았는지 확인하는 화면입니다.",
      title: "활동 기록 | FanLetter",
    };
  }

  return {
    description:
      "See how your actions become activity records on FanLetter.",
    title: "Activity Records | FanLetter",
  };
}
