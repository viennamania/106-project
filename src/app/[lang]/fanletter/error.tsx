...
// Navigation error boundary for the FanLetter surface. Catches runtime errors
// thrown while rendering a fanletter route segment (e.g. a failed data fetch
// during navigation) and offers in-place recovery instead of a frozen screen.
import { RefreshCw } from "lucide-react";
import Link from "next/link";
import { usePathname } from "next/navigation";
import { useEffect } from "react";

export default function FanletterError({
  error,
  unstable_retry,
}: {
  ...
  useEffect(() => {
    // Surface the error to the browser console / error reporting.
    console.error(error);
  }, [error]);
