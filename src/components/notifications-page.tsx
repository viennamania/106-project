    ...
    <div className="relative isolate overflow-hidden">
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-4 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
        <LandingReveal delay={10} variant="soft">
          <header className="glass-card sticky top-[calc(env(safe-area-inset-top)+0.75rem)] z-30 flex flex-col gap-3 rounded-[22px] border-white/80 bg-white/84 px-4 py-3 shadow-[0_18px_44px_rgba(15,23,42,0.12)] backdrop-blur-xl sm:rounded-[26px] sm:px-5 sm:py-4 lg:static lg:bg-white/82 lg:shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
