  ...
  switch (locale) {
    case "ko":
      return {
        ...
        nameHelp: "공개 콘텐츠와 AI 스타 유니버스에 노출되는 이름입니다.",
        nameLabel: "AI 스타 이름",
    ...
    default:
      return {
        ...
        nameHelp: "This name appears in public content and AI Star Universe.",
            ...
            <div className="p-5 sm:p-7">
              ...
              {state.status === "loading" ? (
                ...
                <div className="grid gap-5">
                  ...
                  >
                    {locale === "ko" ? "공개 콘텐츠에서 확인" : "View public content"}
