    ...
    () =>
      isFeedTarget
        ...
        ? {
            ...
            intro:
              `카카오톡 안에서는 이메일 로그인과 결제 흐름이 제한될 수 있습니다. 이미 설치했다면 홈 화면의 ${SERVICE_BRAND_NAME} 앱을 직접 열고, 아니라면 먼저 외부 브라우저에서 이어가는 것을 권장합니다.`,
            installTitle: "브라우저나 홈 화면 앱으로 이어가세요",
            installSteps:
              platformHint === "ios"
                ? [
                    `이미 설치했다면 홈 화면의 ${SERVICE_BRAND_NAME} 앱을 직접 열어보세요.`,
        ...
        : {
            ...
            eyebrow: "KAKAO REFERRAL BRIDGE",
            intro:
              `KakaoTalk's in-app browser can limit login and payment steps. If ${SERVICE_BRAND_NAME} is already installed, open it from your home screen. Otherwise, continue in an external browser first.`,
            installTitle: "Continue in a browser or open the home screen app",
            installSteps:
              platformHint === "ios"
                ? [
                    `If ${SERVICE_BRAND_NAME} is already installed, open it directly from your home screen.`,
