...
function getActivationHubCopy(locale: Locale) {
  if (locale === "ko") {
    return {
      ...
      pointsDescription: "누적 적립과 실제 교환 가능 잔액을 구분해서 봅니다.",
      pointsLabel: "리워드 포인트",
      pointsMetricCta: "교환 가능 잔액",
  ...
  return {
    ...
    menuReadyTitle: "Recommended next action",
    ...
    pointsDescription: "Separate lifetime earned points from the actual redeemable balance.",
    pointsLabel: "Reward points",
    pointsMetricCta: "Redeemable balance",
