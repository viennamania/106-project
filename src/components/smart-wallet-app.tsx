...
function getActivationHubCopy(locale: Locale) {
  if (locale === "ko") {
    return {
      ...
      feedDescription: "공개 콘텐츠와 리포트 작성자를 확인합니다.",
      feedLabel: "공개 콘텐츠",
      feedMetric: "콘텐츠 보기",
      hubLabel: "1066FRIEND+",
      ...
      pointsDescription: "사용 가능한 포인트와 교환 이력을 확인합니다.",
      pointsLabel: "포인트 교환",
  ...
  return {
    ...
    pointsDescription: "Review usable points and redemption history.",
