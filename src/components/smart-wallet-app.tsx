...
function getActivationHubCopy(locale: Locale) {
  if (locale === "ko") {
    return {
      ...
      pointsDescription: "추천 보상 누적 포인트와 교환 가능 포인트를 확인합니다.",
      pointsLabel: "포인트 관리",
      pointsMetricPrefix: "누적 보상",
  ...
  return {
    ...
    pointsDescription: "Review referral reward points and redeemable balance.",
    pointsLabel: "Points",
    pointsMetricPrefix: "Reward total",
