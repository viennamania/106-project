...
function getActivationHubCopy(locale: Locale) {
  if (locale === "ko") {
    return {
      ...
      feedDescription: "공개 콘텐츠와 AI 스타 피드를 둘러봅니다.",
      feedLabel: "공개 콘텐츠",
      feedMetric: "보기",
      hubLabel: "1066FRIEND+",
      ...
      menuPendingDescription: "10 USDT 확인이 끝나면 추천 회원, 포인트, 지갑 메뉴가 열립니다.",
      ...
      networkDescription: "내 추천 코드로 가입한 회원을 확인합니다.",
      networkLabel: "추천 회원 보기",
      notReady: "설정 필요",
      pending: "결제 확인 필요",
      pendingMessage: "10 USDT 결제 확인이 끝나면 추천 코드와 포인트 메뉴가 열립니다.",
      pointsDescription: "교환 가능 포인트와 리워드 사용 이력을 확인합니다.",
      pointsLabel: "포인트 리워드",
      ...
      ready: "완료",
      readyMessage: "가입이 완료되었습니다. 추천 회원을 확인하거나 포인트 리워드를 확인하세요.",
      recommendedLabel: "먼저 확인",
      secondaryLabel: "다음 행동",
      shareDescription: "내 추천 랜딩과 공유 링크를 확인합니다.",
      shareLabel: "추천 코드 / 랜딩",
      statusTitle: "현재 위치",
      ...
      studioDescription: "AI 스타 이름, 프로필 이미지, 콘텐츠 작업을 확인합니다.",
      studioLabel: "AI 스타 관리",
      studioProfileMetric: "이름/이미지 설정",
      studioReadyMetric: "콘텐츠 만들기",
  ...
  return {
    ...
    pointsDescription: "Review redeemable points and usage history.",
    pointsLabel: "Points",
    ...
    studioProfileMetric: "Name / image",
    studioReadyMetric: "Create content",
