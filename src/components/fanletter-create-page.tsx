...
function getCopy(locale: Locale) {
  return locale === "ko"
    ? {
        ...
        accountRequiredBody:
          "첫 일상 에피소드를 만들려면 FanLetter 계정 연결을 먼저 완료해야 합니다.",
        accountRequiredCta: "계정 연결하기",
        back: "프로필로 돌아가기",
        body: "에피소드 본문",
        bodyHint:
          "비워두면 오늘의 장면 프롬프트를 본문으로 사용합니다. 팬에게 보여줄 설명을 짧게 다듬어도 됩니다.",
        bodyPlaceholder: "팬에게 보여줄 에피소드 설명을 입력하세요.",
        contentReady: "오늘의 에피소드가 준비되었습니다.",
        draft: "임시 저장",
        draftSaved: "임시 저장했습니다.",
        emptyPrompt: "오늘의 일상 장면을 입력하세요.",
        errorFallback: "첫 일상 에피소드를 처리하지 못했습니다.",
        eyebrow: "FanLetter Daily Episode",
        feed: "FanLetter 일상 피드 보기",
        free: "무료 공개",
        generate: "에피소드 생성",
        generated: "생성 완료",
        ...
        studio: "연재 스튜디오",
        title: "제목",
        titlePlaceholder: "오늘의 에피소드 제목",
        titleText: "오늘의 일상 에피소드를 바로 만드세요.",
        video: "동영상 일상",
        videoBody:
          "세로형 동영상 에피소드를 생성해 모바일 일상 피드에 바로 연결합니다.",
        viewContent: "에피소드 보기",
      }
    : {
        accountRequired: "Account connection required.",
        accountRequiredBody:
          "Connect your FanLetter account before creating the first daily episode.",
        accountRequiredCta: "Connect account",
        back: "Back to profile",
        body: "Episode body",
        bodyHint:
          "When empty, the daily scene prompt is used as the body. You can also write a shorter fan-facing description.",
        bodyPlaceholder: "Write the episode description for fans.",
        contentReady: "Today's episode is ready.",
        draft: "Save draft",
        draftSaved: "Draft saved.",
        emptyPrompt: "Enter today's daily scene.",
        errorFallback: "Failed to process first daily episode.",
        eyebrow: "FanLetter Daily Episode",
        feed: "View FanLetter daily feed",
        free: "Free public",
        ...
        image: "Image daily",
        imageBody:
          "Use the persona and avatar together to create today's selfie or daily scene.",
        loading: "Checking episode setup.",
        missingMedia: "Generate an image or video before publishing.",
        paid: `${CONTENT_PAID_USDT_AMOUNT} USDT paid`,
        paymentRequired: "Only completed members can create the first daily episode.",
        ...
        profileRequiredBody:
          "The first daily episode works better after setting a display name and character persona.",
        profileRequiredCta: "Set up profile",
        prompt: "Today's scene",
        promptPlaceholder:
          "Describe location, mood, action, selfie style, and daily-life feel.",
        publish: "Publish episode",
        published: "Published.",
        result: "Episode preview",
        summary: "Summary",
        summaryPlaceholder: "Short intro",
        studio: "Serial studio",
        title: "Title",
        titlePlaceholder: "Today's episode title",
        titleText: "Create today's daily episode inside FanLetter.",
        video: "Video daily",
        videoBody:
          "Generate a vertical video episode that connects directly to the mobile daily feed.",
        viewContent: "View episode",
      };
}
