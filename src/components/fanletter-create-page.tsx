...
function getCopy(locale: Locale) {
  return locale === "ko"
    ? {
        ...
        accountRequiredBody:
          "첫 콘텐츠를 만들려면 FanLetter 계정 연결을 먼저 완료해야 합니다.",
        accountRequiredCta: "계정 연결하기",
        back: "프로필로 돌아가기",
        body: "본문",
        bodyHint:
          "비워두면 프롬프트를 본문으로 사용합니다. 팬에게 보여줄 설명을 짧게 다듬어도 됩니다.",
        bodyPlaceholder: "팬에게 보여줄 콘텐츠 설명을 입력하세요.",
        contentReady: "생성된 콘텐츠가 준비되었습니다.",
        draft: "임시 저장",
        draftSaved: "임시 저장했습니다.",
        emptyPrompt: "AI 콘텐츠를 만들 프롬프트를 입력하세요.",
        errorFallback: "첫 콘텐츠를 처리하지 못했습니다.",
        eyebrow: "FanLetter First Content",
        feed: "FanLetter 피드 보기",
        free: "무료 공개",
        generate: "AI 콘텐츠 생성",
        generated: "생성 완료",
        ...
        video: "AI 동영상",
        videoBody:
          "세로형 동영상 콘텐츠를 생성해 모바일 팬 피드에 바로 연결합니다.",
        viewContent: "콘텐츠 보기",
      }
    : {
        accountRequired: "Account connection required.",
        accountRequiredBody:
          "Connect your FanLetter account before creating first content.",
        accountRequiredCta: "Connect account",
        back: "Back to profile",
        body: "Body",
        bodyHint:
          "When empty, the prompt is used as the body. You can also write a shorter fan-facing description.",
        bodyPlaceholder: "Write the content description for fans.",
        contentReady: "Generated content is ready.",
        draft: "Save draft",
        draftSaved: "Draft saved.",
        emptyPrompt: "Enter a prompt to generate AI content.",
        errorFallback: "Failed to process first content.",
        eyebrow: "FanLetter First Content",
        feed: "View FanLetter feed",
        free: "Free public",
        ...
        image: "AI image",
        imageBody:
          "Use the persona and avatar together to create an image for the fan feed.",
        loading: "Checking content setup.",
        missingMedia: "Generate an image or video before publishing.",
        paid: `${CONTENT_PAID_USDT_AMOUNT} USDT paid`,
        paymentRequired: "Only completed members can create first content.",
        ...
        profileRequiredBody:
          "First content works better after setting a display name and character persona.",
        profileRequiredCta: "Set up profile",
        prompt: "Prompt",
        promptPlaceholder:
          "Describe scene, expression, background, styling, and camera feel.",
        publish: "Publish now",
        published: "Published.",
        result: "Preview",
        summary: "Summary",
        ...
        video: "AI video",
        videoBody:
          "Generate vertical video content that connects directly to the mobile fan feed.",
