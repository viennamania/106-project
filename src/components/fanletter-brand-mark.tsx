...
export function FanletterBrandMark({
  className,
  title,
  ...props
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          id="fanletter-brand-mark-stroke"
          x1="22"
          x2="78"
          y1="70"
          y2="24"
      ...
      />
      <g
        filter="url(#fanletter-brand-mark-glow)"
        stroke="url(#fanletter-brand-mark-stroke)"
        strokeLinecap="round"
      ...
      <path
        ...
        fill="url(#fanletter-brand-mark-fill)"
      />
    </svg>
  );
}
