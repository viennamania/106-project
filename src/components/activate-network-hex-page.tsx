...
function getHexCopy(locale: Locale) {
  const copy = {
    en: {
      ...
      aiStar: "AI Star profile",
      card: "Member card",
      close: "Close",
      currentFocus: "Current focus",
      detailSubtitle: "Check this member's slot, points, wallet, and AI Star profile.",
    ...
    id: {
      ...
      aiStar: "Profil AI Star",
      card: "Kartu member",
      close: "Tutup",
      currentFocus: "Fokus saat ini",
      detailSubtitle: "Cek slot, poin, dompet, dan profil AI Star member ini.",
    ...
    ja: {
      ...
      close: "閉じる",
      currentFocus: "現在の中心",
      detailSubtitle: "この会員のスロット、ポイント、ウォレット、AIスタープロフィールを確認します。",
      detailTitle: "会員詳細",
    ...
    ko: {
      ...
      close: "닫기",
      currentFocus: "현재 중심",
      detailSubtitle: "선택한 회원의 슬롯, 포인트, 지갑, AI 스타 프로필을 확인합니다.",
      detailTitle: "회원 상태",
      directMembers: "직속 회원",
      lifetimePoints: "누적 P",
      noAiStar: "아직 없음",
    ...
    vi: {
      ...
      aiStar: "Hồ sơ AI Star",
      card: "Thẻ thành viên",
      close: "Đóng",
      currentFocus: "Trọng tâm hiện tại",
      detailSubtitle: "Kiểm tra slot, điểm, ví và hồ sơ AI Star của thành viên này.",
    ...
    zh: {
      ...
      close: "关闭",
      currentFocus: "当前中心",
      detailSubtitle: "查看该会员的槽位、积分、钱包和 AI明星资料。",
      detailTitle: "会员详情",
      directMembers: "直属会员",
      lifetimePoints: "累计积分",
      noAiStar: "尚未创建",
