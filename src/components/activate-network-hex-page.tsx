...
function getHexCopy(locale: Locale) {
  const copy = {
    en: {
      ...
      detailSubtitle: "Check this member's slot, points, wallet, and AI Star IP.",
    ...
    id: {
      ...
      detailSubtitle: "Cek slot, poin, dompet, dan IP AI Star member ini.",
    ...
    ja: {
      ...
      close: "閉じる",
      currentFocus: "現在の中心",
      detailSubtitle: "この会員のスロット、ポイント、ウォレット、AI Star IPを確認します。",
      detailTitle: "会員詳細",
    ...
    ko: {
      ...
      close: "닫기",
      currentFocus: "현재 중심",
      detailSubtitle: "이 회원의 슬롯, 포인트, 지갑, AI 스타 IP를 확인합니다.",
      detailTitle: "회원 상세",
      directMembers: "직속 회원",
      lifetimePoints: "누적 P",
      noAiStar: "아직 없음",
    ...
    vi: {
      ...
      detailSubtitle: "Kiểm tra slot, điểm, ví và IP AI Star của thành viên này.",
    ...
    zh: {
      ...
      close: "关闭",
      currentFocus: "当前中心",
      detailSubtitle: "查看该会员的槽位、积分、钱包和 AI Star IP。",
      detailTitle: "会员详情",
      directMembers: "直属会员",
      lifetimePoints: "累计积分",
      noAiStar: "尚未创建",
