...
function getCopy(locale: Locale) {
  return locale === "ko"
    ? {
        ...
        helper:
          "계정 연결 후 회원 API 동기화가 끝나야 프로필 설정과 콘텐츠 생성 단계로 이동할 수 있습니다.",
    ...
    : {
        ...
        eyebrow: "FanLetter Account",
        helper:
          "After account connection, member API sync must finish before profile and content steps can continue.",
