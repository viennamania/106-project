...
const eventTone = {
  ...
  content_published: "border-emerald-100 bg-emerald-50 text-emerald-700",
  content_publish_failed: "border-rose-100 bg-rose-50 text-rose-700",
  ...
  creator_social_disconnected: "border-orange-100 bg-orange-50 text-orange-700",
...
const eventIconMap = {
  ...
  content_publish_failed: SlidersHorizontal,
  cp_earned: Coins,
