...
function getCopy(locale: Locale) {
  return locale === "ko"
    ? {
        ...
        description:
          "유료 브이로그 판매, 구매자 확인, 판매용 지갑 잔고, 회수 상태를 FanLetter 안에서 관리합니다.",
        emptyHistory:
        ...
        noWallet:
          "유료 브이로그 판매 수익을 받으려면 thirdweb server wallet 기반 판매용 지갑이 필요합니다.",
        paymentRequired:
          "가입 완료 회원만 FanLetter 판매 내역을 관리할 수 있습니다.",
        submitted:
    ...
    : {
        ...
        description:
          "Manage paid vlog sales, buyers, seller wallet balance, and withdrawals inside FanLetter.",
        emptyHistory:
        ...
        noWallet:
          "Paid vlog sales require a thirdweb server wallet seller address.",
        paymentRequired:
          "Completed members can manage FanLetter sales.",
        submitted:
