...
function getCopy(locale: Locale) {
  if (locale === "ko") {
    return {
      ...
      formula: "ERS 반영 공식",
      heroBody:
        "FanLetter에서 발생한 한 행동 기록이 어떤 증거, 품질 점검, 보상/기여 신호로 이어졌는지 확인합니다.",
      heroEyebrow: "평판 기록 증거",
      object: "대상",
      oracle: "Oracle 준비",
  ...
  return {
    ...
    heroBody:
      "Review the evidence, quality checks, and reward or contribution signals created by one FanLetter action record.",
    heroEyebrow: "Reputation record evidence",
    object: "Object",
    oracle: "Oracle-ready",
    oracleEvidenceTrace: "Oracle Evidence Trace",
    oracleEvidenceTraceBody:
    ...
    title: "Reputation Record Detail",
