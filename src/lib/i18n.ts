  ...
  en: {
    ...
    activateNetworkPage: {
      ...
      labels: {
        ...
        totalLifetimePoints: "Downline total points",
        totalMembers: "Total members",
        totalOtherPoints: "Other points",
        totalReferralRewardPoints: "Referral reward points",
        totalSpendablePoints: "Downline spendable points",
  ...
  ja: {
    ...
    activateNetworkPage: {
      ...
      labels: {
        ...
        totalLifetimePoints: "下位ネットワークのポイント合計",
        totalMembers: "全体会員数",
        totalOtherPoints: "その他ポイント",
        totalReferralRewardPoints: "紹介報酬ポイント",
        totalSpendablePoints: "下位の利用可能ポイント合計",
  ...
  zh: {
    ...
    activateNetworkPage: {
      ...
      labels: {
        ...
        totalLifetimePoints: "下级网络积分合计",
        totalMembers: "全网会员数",
        totalOtherPoints: "其他积分",
        totalReferralRewardPoints: "推荐奖励积分",
        totalSpendablePoints: "下级可用积分合计",
        walletAddress: "钱包地址",
      },
      actions: {
