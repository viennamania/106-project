...
const dictionaries: Record<BuiltInLocale, Dictionary> = {
  ...
  en: {
    ...
    activateNetworkPage: {
      ...
      eyebrow: "network control",
      description:
        "Manage completed members who joined with your code, including network structure, tier lifetime points, redeemable points, point tier, and member card status.",
      disconnected:
      ...
      selectionHint:
        "Pick a member from the list or network map to review tier lifetime points, point tier, card status, and network depth instantly.",
      leaderboardDescription:
      ...
      labels: {
        ...
        totalLifetimePoints: "Downline tier lifetime points",
        totalMembers: "Total members",
        totalOtherPoints: "Other points",
        totalReferralRewardPoints: "Referral reward points",
        totalSpendablePoints: "Downline redeemable points",
    ...
    rewardsPage: {
      ...
      labels: {
        ...
        pointsToNextTier: "{points}P needed for next tier",
      ...
      catalog: {
        ...
        previewBadge: "live",
        eligible: "Eligible",
        needMorePoints: "Need {points}P to redeem",
  ...
  ja: {
    ...
    activateNetworkPage: {
      ...
      labels: {
        ...
        totalLifetimePoints: "下位のランク用累積ポイント",
        totalMembers: "全体会員数",
        totalOtherPoints: "その他ポイント",
        totalReferralRewardPoints: "紹介報酬ポイント",
        totalSpendablePoints: "下位の交換可能ポイント合計",
    ...
    rewardsPage: {
      ...
      labels: {
        ...
        nextTier: "次の等級",
        pointTier: "現在のポイント等級",
        pointsToNextTier: "次の等級まで {points}P 必要",
        progress: "等級進行度",
      ...
      catalog: {
        ...
        previewBadge: "live",
        eligible: "到達可能",
        needMorePoints: "交換まで {points}P 不足",
  ...
  zh: {
    ...
    activateNetworkPage: {
      ...
      labels: {
        ...
        totalLifetimePoints: "下级等级累计积分合计",
        totalMembers: "全网会员数",
        totalOtherPoints: "其他积分",
        totalReferralRewardPoints: "推荐奖励积分",
        totalSpendablePoints: "下级可兑换积分合计",
        walletAddress: "钱包地址",
      },
      actions: {
    ...
    rewardsPage: {
      ...
      labels: {
        ...
        nextTier: "下一等级",
        pointTier: "当前积分等级",
        pointsToNextTier: "距下一等级还需 {points}P",
        progress: "等级进度",
        rewardCatalog: "奖励目录",
        rewardCost: "所需积分",
        earnHistory: "积分记录",
